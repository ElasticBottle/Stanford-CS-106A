...
public interface FacePamphletConstants {
	...
	/** "No Image" text that is displayed to user if there is 
	 * no Profile image associated with the user */
	public static final String PROFILE_IMAGE_TEXT = "No Image";
	...
	/** The number of vertical pixel in the vertical margin between names
	 * of friends in the friends list. 
	 */
	public static final double FRIEND_MARGIN = 3;
